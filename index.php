...
<rect width="400" height="300" fill="pink"  stroke-width="8" stroke="red" />
<text fill="res" font-size="50" font-family="verdana" x="40" y="56" talign="top">Online Quiz</text> not supported</svg>
<br><br>
	   <h1 class="style8" style="background-color:white">Welcome to Online Quiz</h1>
      <span class="style5"><img src="images/imagesq.jpg" width="500" height="400"><span></span>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p align="left" class="style5" style="font-size:500" style="font-color:blue" ><span class="style7" >Wel Come to Online 
    ...
    <td valign="top"><form name="form1" method="post" action="">
      ...
      <div align="center">
        <p class="style5"><img src="images/images2.png" width="134" height="128">          </p>
        </div>
		
		<img src="images\download.jpg" width="150" height="128">
		<p class="style5" align="center"><img src="images\images.jpg" width="150" height="128">
		<p class="style5" align="right"><img src="images\download (1).jpg" width="150" height="128">
