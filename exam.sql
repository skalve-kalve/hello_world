...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2017 at 12:59 PM
...
('amit', 8, '0000-00-00', 3),
('amit', 8, '0000-00-00', 1),
('raj', 11, '0000-00-00', 11),
('raj', 12, '0000-00-00', 4),
('raj', 8, '0000-00-00', 2),
('raj', 13, '0000-00-00', 9),
('skalve97@gmail.com', 8, '0000-00-00', 2),
('skalve97@gmail.com', 15, '0000-00-00', 8),
('skalve97@gmail.com', 16, '0000-00-00', 1),
('skalve97@gmail.com', 10, '0000-00-00', 3),
('skalve97@gmail.com', 11, '0000-00-00', 8);
...
(17, 'skalve97@gmail.com', '1234', 'shital kalve', 'ramanager aurangabad', 'aurangabad', 2147483647, 'skalve97@gmail.com '),
(18, '', '', '', '', '', 0, ''),
(19, 'Bittugore@gmail.com', '9595', 'bittu gore', 'CHAWANAI', 'aurangabad', 2147483647, 'Bittugore@gmail.com'),
(20, 'shwetagore@gmail.com', '1234', 'shweta gore', 'chawni aurangabad', 'aurangabad', 2147483647, 'shwetagore@gmail.com');
...
('u8i11u816o6r4mfdekljlq3vk7', 13, 'Word Text can be made italic by____________________', 'Ctrl+I', 'Ctrl+B', 'Ctrl+U', 'None of the above', 1, 1),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'Spelling check is not possible in ___________________', 'Normal View', 'Out Line View', 'Print Lay Out View', 'None of these', 4, 4),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'to start a new line', 'enter', 'shift+enter', 'ctrl+enter', 'none of these', 1, 1),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'to delete the selected sentence we can press the following press', 'del', 'backspace', 'both a&b', 'none of the above', 3, 1),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'the document can be zoomed maximum up to', '100%', '150%', '200%', '500%', 4, 4),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'when microsoft word gets loaded the opening screen display a document named', 'document1', 'document', 'doc1', 'no document name', 1, 4),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'alignment buttons are available on______________', 'ststus bar', 'for mating toolbar', 'standerd toolbar', 'none of these', 2, 3),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'which of the follwing is not option of edit menu', 'cut', 'copy', 'page setup', 'paste', 3, 3),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'if you want to copy a selection of text,which button do you click?', 'move', 'copy', 'duplicate', 'cut', 2, 2),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'the date and time command', 'inaert the date & time you specify', 'insert current system date & time', 'inmsert last updated date & time', 'none of the above', 2, 2),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'the list in bottom of the file menu', 'display last foure file you use', 'display all opened files', 'allow to close file', 'none of the above', 1, 4),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'bold,italic,underline are the part of_________toolbar', 'formating', 'standerd', 'drawing', 'central', 1, 3),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'to set the shading for the paragrph in ms-word chose', 'insert shading', 'format border & shading', 'view shading', 'all the above', 2, 4),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'to change the size of document page using', 'file properties', 'file page setup', 'tools option', 'format paragraph', 2, 2),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'which sortcut key is used to redo action?', 'ctrl+r', 'ctrl+y', 'ctrl+e', 'ctrl+u', 2, 3),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'which is the shortcut key to replace the text', 'ctrl+r', 'ctrl+h', 'ctrl+d', 'ctrl+e', 2, 1),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'which option is not present under tool menu', 'mail merge', 'auto text', 'language', 'drop cap', 4, 3),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'to convert \"the computer\" in to \"THE COMPUTER\" which option is used', 'title case', 'toggle case', 'upper case', 'all caps', 3, 1),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'to appear the same information at the top or bottom of each page we use', 'headers & footer', 'hyperlink', 'field', 'none', 1, 1),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'in ms-word to appear full form abberiatin automatically we can use', 'autotext', 'auto correct', 'comments', 'drop cap', 1, 2),
('u8i11u816o6r4mfdekljlq3vk7', 8, 'What is Default Form Border Style ?', 'Fixed Single', 'None', 'Sizeable', 'Fixed Diaglog', 3, 2),
('u8i11u816o6r4mfdekljlq3vk7', 8, 'Which is not type of Control ?', 'text', 'lable', 'checkbox', 'option button', 1, 1),
('u8i11u816o6r4mfdekljlq3vk7', 8, 'What  Default Data Type ?', 'String', 'Variant', 'Integer', 'Boolear', 2, 2),
('u8i11u816o6r4mfdekljlq3vk7', 13, 'By Default Word Format your text as', '14 Point Times New Roman', '12 Point Times New Roman', '11 point Times New Roman', 'None of the above', 2, 4),
('19rls2f7lvibp4so2n8rjagld5', 8, 'What  Default Data Type ?', 'String', 'Variant', 'Integer', 'Boolear', 2, 3),
('19rls2f7lvibp4so2n8rjagld5', 8, 'What is Default Form Border Style ?', 'Fixed Single', 'None', 'Sizeable', 'Fixed Diaglog', 3, 3),
('19rls2f7lvibp4so2n8rjagld5', 8, 'Which is not type of Control ?', 'text', 'lable', 'checkbox', 'option button', 1, 1),
('octsls1bu4fouj9o7b4hduudn3', 11, 'how many keyword are there in c?', '56', '54', '64', '32', 4, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, 'for multiline comment ___ is used', '//', '??', '/*', '*', 3, 1),
('octsls1bu4fouj9o7b4hduudn3', 11, 'strlen() return _____ types of data ?', 'integer', 'character', 'string', 'void', 1, 3),
('octsls1bu4fouj9o7b4hduudn3', 11, 'To come out of c __shortcut key is used?', 'alt+b', 'alt+k', 'alt+m', 'alt+x', 4, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, 'who invented c language ?', 'Denis Ritchie', 'Pascal Blaise', 'Denis reddy', 'Bill gets', 1, 1),
('octsls1bu4fouj9o7b4hduudn3', 11, 'short cut key to save is _', 'f4', 'f9', 'f2', 'f1', 3, 1),
('octsls1bu4fouj9o7b4hduudn3', 11, 'short cut key to close the program?.?', 'f7', 'f3', 'f8', 'f9', 2, 1),
('octsls1bu4fouj9o7b4hduudn3', 11, 'How many data types are there in c ?', '8', '7', '6', '5', 3, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, 'Range of integer type of data ?', '-32768 to 32767', '123-133', '152 to 258', '-78954 to 32564', 1, 2),
('octsls1bu4fouj9o7b4hduudn3', 11, 'getchar() is used to get ?', 'integer', 'string', 'character', 'print', 3, 3),
('octsls1bu4fouj9o7b4hduudn3', 11, 'gets() is used to get???', 'number', 'character', 'string', 'integer', 3, 3),
('octsls1bu4fouj9o7b4hduudn3', 11, '\"default: \" statement is a part of ___', 'switch case', 'If else', 'if', 'loop', 1, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, 'or operator in c is ________type of operator ?', 'arethametic', 'logical', 'bitwise', 'conditional', 2, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, '___is assignment operator in c ?', '*', '++', '=', '--', 3, 3),
('octsls1bu4fouj9o7b4hduudn3', 11, 'Every function returns___type of value ?', 'int', 'char', 'float', 'none of these', 4, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, 'what is the answer of 8%5', '4.5', '3', '1', '1.3', 2, 4),
('octsls1bu4fouj9o7b4hduudn3', 11, 'gets() is defined in ?', 'stdio.h', 'conio.h', 'string.h', 'dos.h', 1, 1),
('octsls1bu4fouj9o7b4hduudn3', 11, '__key is used to zoom the screen', 'f5', 'f6', 'f9', 'alt+f9', 1, 3),
('octsls1bu4fouj9o7b4hduudn3', 11, '____decision making control', 'for loop', 'do while', 'function', 'switch case', 4, 2);
